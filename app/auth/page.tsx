    ...
    >
      ...
      >
        <svg
          ...
          style={{ maxWidth: "62%", height: "auto", color: "#000000", animation: "logoReveal 6s ease-in-out infinite" }}
        >
          <path
      ...
      <style>{`
        /* Logo sits invisible (black on black); a light sweeps across and reveals it, then it fades back */
        @keyframes logoReveal {
          0%, 55%, 100% { color: #000000; }
          70% { color: #ffffff; }
          85% { color: #000000; }
        }
      `}</style>
