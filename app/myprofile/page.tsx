      ...
      <div style={{ padding: "0 20px", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 12 }}>
            {/* Name */}
            <div style={{ color: COLORS.text, fontSize: 17, fontWeight: 700, fontFamily: FONT }}>{user?.name || "User"}</div>
        ...
        {recipes.length === 0 ? (
          <div style={{ color: COLORS.textTertiary, fontSize: 14, fontFamily: FONT, textAlign: "center", paddingTop: 12 }}>
            No recipes yet
          </div>
        ) : (
