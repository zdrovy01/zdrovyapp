  ...
  if (!recipe) {
    return (
      <>
        ...
        <div style={{ padding: 20, color: COLORS.textSecondary }}>Recipe not found.</div>
      </>
    );
  }
    ...
    <>
      ...
      <div style={{ padding: "0 20px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
          <h1 style={{ margin: 0, color: COLORS.text, fontSize: 24, fontWeight: 800 }}>{recipe.name}</h1>
          <div style={{ ...cardStyle, padding: "8px 14px", borderRadius: 4, color: COLORS.text, fontWeight: 700, fontSize: 16, flexShrink: 0 }}>
        ...
        {/* Macros */}
        <div style={{ color: COLORS.textSecondary, fontSize: 14, display: "flex", gap: 16, flexWrap: "wrap" }}>
            ...
            <div className="hide-scrollbar" style={{ display: "flex", gap: 10, overflowX: "auto", paddingBottom: 4 }}>
              {ingredients.map((ing, i) => (
                <div key={i} style={{ ...cardStyle, flex: "0 0 150px", padding: 12 }}>
                  <div style={{ color: COLORS.text, fontWeight: 600, fontSize: 15, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                    {ing.name}
                  </div>
                  {(ing.amount || ing.unit) && (
                  ...
                  {ing.price != null && (
                    <div style={{ color: COLORS.text, fontWeight: 700, fontSize: 14, marginTop: 8 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {steps.map((st, i) => (
                <div key={i} style={{ ...cardStyle, padding: 14 }}>
                  <div style={{ color: COLORS.textSecondary, fontWeight: 700, fontSize: 14, marginBottom: 4 }}>Step {i + 1}</div>
                  <div style={{ color: COLORS.text, fontSize: 15, lineHeight: 1.45 }}>{st.text}</div>
                  {st.ingredient && (
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          <button
            ...
            style={{
              ...
              background: COLORS.text, color: COLORS.background, fontSize: 16, fontWeight: 600, cursor: "pointer",
            }}
          >
            Start cooking
          </button>
