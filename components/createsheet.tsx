...
const options: { label: string; href: string; icon: React.ReactNode }[] = [
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <rect x="2" y="2" width="18" height="18" rx="2" stroke="var(--c-text,#F5F5F5)" strokeWidth="1.8" />
        <path d="M6 8h10M6 12h10M6 16h6" stroke="var(--c-text,#F5F5F5)" strokeWidth="1.8" strokeLinecap="round" />
      </svg>
    ),
  },
  {
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        {/* Title */}
        <div style={{ textAlign: "center", color: COLORS.text, fontSize: 17, fontWeight: 700, fontFamily: FONT, padding: "14px 0 6px" }}>
          Create
        </div>
        ...
        {options.map((o, i) => (
          ...
          >
            ...
            <span style={{ color: COLORS.text, fontSize: 16, fontWeight: 500 }}>{o.label}</span>
          </button>
        ))}
      </div>
